public class Plateau {
    ...
    public static void main(String[] args) {
        ...
        int longestPlateauStartIndex = 0; // initial -1 -> dadurch können wir später sehen, ob überhaupt ein Plateaus gefunden wurde
        ...
        if(longestPlateauStartIndex == 0 || numbers[longestPlateauStartIndex]==numbers.length-1-longestPlateauLength ) {
